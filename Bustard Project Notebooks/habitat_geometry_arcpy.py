...
INPUT_TABLE = r"C:\Users\PangY\OneDrive - Smithsonian Institution\Bustard\01_Data\Reneco\Vegetation Cover and Food Availability Studies\Phytosociological_complementary_habitat_Tamlelt_0610.xlsx"
SHEET_NAME = 0  # sheet name or zero-based sheet index

OUTPUT_DIR = r"C:\Users\PangY\OneDrive - Smithsonian Institution\Bustard\01_Data\Habitat mapping"
OUTPUT_PREFIX = "Phytosociological_habitat_Tamlelt_0610_geomtry.shp"
...
def main() -> None:
    ...
    log(f"Created polygons: {counters['created']}")generate_habitat_geometry_arcpy.py
