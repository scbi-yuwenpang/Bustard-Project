...
prepared outputs already created for:
  ...
  - Al Baten farms / Bouarfa 2024 cultivated polygons
...
-------------------
import sys
sys.path.append(r"C:\Users\PangY\OneDrive - Smithsonian Institution\Bustard\Scripts")
...
class FinalMergeConfig:
    ...
    # ============================================================
    # 1. Phytosociological field footprints
    # ============================================================
    ...
    # ============================================================
    # 2. Hayat + Trophic harmonized pilot polygons
    # ============================================================
    ...
    # ============================================================
    # 3. Reviewed cultivated/fallow data
    # ============================================================
    ...
    # ============================================================
    # 5. Al Baten interpreted habitat candidates
    # ============================================================
    ...
    # ============================================================
    # 6. Tamlelt interpreted habitat candidates
    # ============================================================
    ...
    def __post_init__(self):
        ...
        # --------------------------------------------------------
        # 1. Phytosociological footprints
        # --------------------------------------------------------
        ...
        if self.phyto_path is None:
            ...
            self.phyto_path = (
                train_dir
                / "Eastern_Morocco_Field_Footprints.gpkg"
            )
        ...
        if self.field_supplement_path is None:
            ...
            self.field_supplement_path = (
                habitat_dir
                / "Field_Supplement_Training_2025.gpkg"
            )


        # --------------------------------------------------------
        # 3. Reviewed cultivation
        # --------------------------------------------------------
        ...
        if self.albaten_wadi_path is None:
            ...
            self.albaten_wadi_path = (
                habitat_dir
                / "Al_Baten_Wadi_Training_2025.gpkg"
            )
        ...
        if self.tamlelt_path is None:
            ...
            self.tamlelt_path = (
                habitat_dir
                / "Tamlelt_Training_2025.gpkg"
            )


        # --------------------------------------------------------
        # 7. Regional training grid
        # --------------------------------------------------------
        ...
        if self.grid_path is None:
            ...
            self.grid_path = (
                train_dir
                / "Eastern_Morocco_Training_Grid.gpkg"
            )


        # --------------------------------------------------------
        # 8. HOT OSM waterways — ancillary only
        # --------------------------------------------------------
...
def build_final_training(
    ...
    *,
    ...
    print("\n[4/9] Al Baten farms")
    raw = read_source(cfg.albaten_farms_path)
    std = standardize_source(
        raw,
        work_crs=work_crs,
        field_grid=field_grid,
    ...
    print("\n[5/9] Bouarfa 2024 cultivated polygons")
    raw = read_source(cfg.bouarfa_2024_path)
    std = standardize_source(
        raw,
        work_crs=work_crs,
        field_grid=field_grid,
